...
export const PRICE_CATEGORIES: PriceCategory[] = [
  ...
  },
  {
    ...
    items: [
      {
        title: 'Электропунктурная рефлексодиагностика по органам и системам',
        price: '3000₽',
      },
      {
        title: 'Электропунктурная рефлексодиагностика позвоночника',
        price: '3000₽',
      },
    ],
  },
  ...
  },
  {
    ...
    items: [
      { title: 'Акупунктурный лифтинг лица (Face Lifting)', price: '6500₽' },
  ...
  },
  {
    ...
    items: [
      {
        title:
          'Процедура мануальной терапии по авторской методике и проводится главным врачом, д.м.н., профессором (мягкотканные техники) до 30 минут',
        price: '3000₽',
      },
      {
        title:
          'Процедура мануальной терапии по авторской методике и проводится главным врачом, д.м.н., профессором (мягкотканные техники) до 60 минут',
        price: '4500₽',
      },
      { title: 'Биодинамическая коррекция позвоночника', price: '5000₽' },
      {
  ...
  },
  {
    ...
    items: [
      ...
      { title: 'Корпоральная иглорефлексотерапия', price: '3000₽' },
      {
        title:
          'Корпоральная иглорефлексотерапия с использованием игл из драгоценных металлов',
        price: '6000₽',
      },
      {
        title:
      ...
      {
        title:
          'Аурикулярная микроиглорефлексотерапия (иглорефлексотерапия длительного действия)',
        price: '1500₽',
      },
      { title: 'Аурикулярная рефлексотерапия (микроиглы)', price: '3700₽' },
      { title: 'Краниорефлексотерапия', price: '3000₽' },
      {
        title: 'Терморефлексотерапия (прогревание сигарами, моксами)',
        price: '2000₽',
      },
      {
        title: 'Вакуумрефлексотерапия (пневматическими банками)',
        price: '1500₽',
      },
      ...
      { title: 'Рефлексотерапия с микрокровопусканием', price: '1000₽' },
      { title: 'Фармакопунктурная рефлексотерапия', price: '6000₽' },
      { title: 'Электрорефлексотерапия / Электроакупунктура', price: '1550₽' },
    ],
  },
  {
    title: 'Массаж',
    items: [
      ...
      { title: 'Массаж спины (до 60 минут)', price: '3500₽' },
      {
      ...
      { title: 'Баночный (вакуумный) массаж до 30 минут', price: '2000₽' },
      { title: 'Массаж при корешковом синдроме (до 45 минут)', price: '3900₽' },
      {
        title: 'Массаж при грыжах межпозвонковых дисков (до 45 минут)',
        price: '3900₽',
      },
      { title: 'Массаж при сколиозе (до 45 минут)', price: '3500₽' },
    ],
  },
  {
    ...
    items: [
      ...
      { title: 'Программа «Лечение остеохондроза», 1 визит', price: '6000₽' },
      {
      ...
      { title: 'Программа «Антитабак», 1 визит', price: '5900₽' },
      { title: 'Программа «Долголетие», 1 визит', price: '5100₽' },
      { title: 'Программа «Иммунитет плюс», 1 визит', price: '5100₽' },
      { title: 'Программы снижения веса, 1 визит', price: '6900₽' },
      {
        title: 'Программа «Реабилитация после травм», 1 визит',
        price: '6500₽',
      },
      { title: 'Программа «Антистресс», 1 визит', price: '5000₽' },
      {
        title: 'Программа «Восстановления после COVID-19», 1 визит',
        price: '5200₽',
      },
      {
  ...
  },
  {
    ...
    items: [
      { title: 'Подкожная инъекция (без стоимости препарата)', price: '300₽' },
      {
        title: 'Внутримышечная иньекция (без стоимости препарата)',
        price: '450₽',
      },
      {
        title: 'Внутривенная инъекция (без стоимости препарата)',
        price: '600₽',
      },
      {
        title:
          'Внутривенная инфузия (без учета стоимости препарата) продолжительностью до 60 мин.',
        price: '1300₽',
      },
      {
        title:
          'Внутривенная инфузия препарата (без учета стоимости препарата) продолжительностью от 60 до 120 мин.',
        price: '2400₽',
      },
      {
        title: 'Внутривенная струйная инфузия (без учета стоимости препарата)',
        price: '800₽',
      },
      { title: 'Экспресс-анализ глюкозы крови', price: '400₽' },
      { title: 'Экспресс тест на антиген COVID-19', price: '1300₽' },
      { title: 'Забор крови для исследований из вены', price: '500₽' },
      {
        title: 'Лечебная блокада паравертебральная (без стоимости препаратов)',
        price: '2500₽',
      },
      {
        title: 'Лечебная блокада периартикулярная (без стоимости препаратов)',
        price: '2700₽',
      },
      { title: 'Наложение компресса', price: '300₽' },
    ],
  },
];
