        ...
        <div className={styles.right}>
          <div className={styles.aboutCard}>
            ...
            <blockquote className={styles.quote}>
              ...
              <p>
                Мы лечим не диагноз из карточки, а человека с его целями, ритмом
                жизни и будущими планами. Результат — это когда пациент
                возвращается к любимым делам без боли.
              </p>
              <span className={styles.quoteMark} aria-hidden="true">
                ”
              </span>
